...
$dirs = @(
    ...
    "apps/sdkwork-browser-pc/packages/sdkwork-browser-pc-react/src",
    "apps/sdkwork-browser-pc/packages/sdkwork-browser-pc-react/tests",
    "apps/sdkwork-browser-pc/packages/sdkwork-browser-pc-react/specs",
    ...
    "crates/sdkwork-browser-storage-sqlx-rust/src",
    "crates/sdkwork-browser-storage-sqlx-rust/migrations",
    "crates/sdkwork-browser-storage-sqlx-rust/specs",
