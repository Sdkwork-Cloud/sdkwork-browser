...
import type { BrowserApiResult, BrowserOperationCommand } from '../types';
...
/** browser.tabs.create */
  async create(body: BrowserOperationCommand): Promise<BrowserApiResult> {
    return this.client.post<BrowserApiResult>(appApiPath(`/browser/tabs`), body, undefined, undefined, 'application/json');
  }
}
...
/** browser.sessions.create */
  async create(body: BrowserOperationCommand): Promise<BrowserApiResult> {
    return this.client.post<BrowserApiResult>(appApiPath(`/browser/sessions`), body, undefined, undefined, 'application/json');
  }
}
...
/** browser.aiActions.create */
  async create(body: BrowserOperationCommand): Promise<BrowserApiResult> {
    return this.client.post<BrowserApiResult>(appApiPath(`/browser/ai/actions`), body, undefined, undefined, 'application/json');
  }
}
