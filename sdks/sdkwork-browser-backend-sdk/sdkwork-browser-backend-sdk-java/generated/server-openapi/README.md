# sdkwork-browser-backend-sdk (Java)
...
<dependency>
    ...
    <artifactId>sdkwork-browser-backend-sdk</artifactId>
...
```groovy
implementation 'com.sdkwork:sdkwork-browser-backend-sdk:0.1.0'
```

## Quick Start

```java
import com.sdkwork.browser.backend.sdk.SdkworkBackendClient;
