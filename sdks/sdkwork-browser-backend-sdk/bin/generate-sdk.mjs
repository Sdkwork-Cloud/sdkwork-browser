...
const PACKAGE_NAMES = {
  typescript: "@sdkwork/browser-backend-sdk",
  rust: "sdkwork-browser-backend-sdk",
  java: "com.sdkwork:sdkwork-browser-backend-sdk",
  python: "sdkwork-browser-backend-sdk",
};
...
function run(argv) {
  ...
  for (const language of args.languages) {
    generateLanguage({
      ...
      sdkName: "sdkwork-browser-backend-sdk",
      sdkType: "backend",
...
function generateLanguage({ language, input, baseUrl, sdkName, sdkType, apiPrefix }) {
  ...
  if (language === "java") {
    commandArgs.push("--namespace", "com.sdkwork.browser.backend.sdk");
  }
